...
\conference{nth Conference on Artificial Progress\\
24 July 1687, Jacksonburg, Wasington}
% NOTE: This will not appear unless the 'journal' option is selected.
...
% Copyright
\copyright{Copyright \textcopyright 2012 by Derek J.~Dalle}
...
\begin{figure}
 ...
 \caption{ \label{fig:f:tol}
  Residuals in \boldmath{$x$}- and \boldmath{$y$}-directions}
\end{figure}
